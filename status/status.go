...
func New(code Code, fmt string, args ...any) *Status {
	if len(args) == 0 {
		if fmt == "" {
...
func Error(code Code, fmt string, args ...any) error {
	if len(args) == 0 {
		if fmt == "" {
...
func OK(fmt string, args ...any) *Status {
...
func Canceled(fmt string, args ...any) error {
...
func Unknown(fmt string, args ...any) error {
...
func InvalidArgument(fmt string, args ...any) error {
...
func DeadlineExceeded(fmt string, args ...any) error {
...
// not found.
func NotFound(fmt string, args ...any) error {
...
// already exists.
func AlreadyExists(fmt string, args ...any) error {
...
func PermissionDenied(fmt string, args ...any) error {
...
func ResourceExhausted(fmt string, args ...any) error {
...
func FailedPrecondition(fmt string, args ...any) error {
...
// etc.
func Aborted(fmt string, args ...any) error {
...
// they are done.
func OutOfRange(fmt string, args ...any) error {
...
// be streaming.
func Unimplemented(fmt string, args ...any) error {
...
func Internal(fmt string, args ...any) error {
...
func Unavailable(fmt string, args ...any) error {
...
func DataLoss(fmt string, args ...any) error {
...
func Unauthenticated(fmt string, args ...any) error {
